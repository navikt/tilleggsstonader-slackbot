...
cron.schedule('0 7 * * MON', () => {
    console.log('sender spørsmål om folk har planlagt fravær');

    sendSpørsmålOmUkentligFravær();
});
...
cron.schedule('0 12 * * 0-4', () => {
    ...
    sendSpørsmålOmKontordag('tilleggsstønader-slackbot', 'C05PAMRAG7L');
});
